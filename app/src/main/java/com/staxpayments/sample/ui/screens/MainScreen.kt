...
fun MainScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            Column {
                ...
                // Add a UI toggle (Switch or RadioButtons) to let the user enable Tap to Pay.
                // When enabled, show a "Connect to Tap Reader" button and connection status.
                // See TAP_TO_PAY.md for the full integration guide.
                ...
                Column(
                    ...
                    // TODO: Enable Tap to Pay
                    // Add a "Connect to Tap Reader" button that calls staxViewModel.connectToTapReader()
                    // WideButton(text = "Connect to Tap Reader") { staxViewModel.connectToTapReader() }
    ...
    // TODO: Enable Tap to Pay
    // Show the SDK's TapToPayPrompt component for NFC transaction UI.
    // Import com.fattmerchant.omni.ui.TapToPayPrompt and wrap in AnimatedVisibility:
    //
    // AnimatedVisibility(visible = showTapToPayPrompt) {
    //     TapToPayPrompt(
    //         amount = "0.01",
    //         subtotal = "0.01",
    //         tip = "0.00",
