...
internal class ChipDnaDriver :
    ...
    override fun registerActivityProvider(activityProvider: () -> android.app.Activity?) {
        val delegate = RequestActivityDelegate(activityProvider)
        registerRequestActivityListener(delegate)
    }
