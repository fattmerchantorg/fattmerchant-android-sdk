...
open class TransactionResult {
    ...
    /**
     * The id of the transaction in the foreign platform.
     *
     * For example, the transaction_id inside the NMI platform
     * */
    internal var transactionForeignId: String? = null

    /** A user-defined string used to refer to the transaction */
    var userReference: String? = null

    /** The raw response from the gateway */
    internal var rawResponse: String? = null
